...
def display():
    ...
    if FarthestFirst:
        twDrawString(TextLeft,-0.5, TextZ, "farthest to nearest; 'f' toggles")
        Quad((0,0,1,0.6),(3,0,-2),0)   # blue 60% farthest
        Quad((0,1,0,1.0),(1,1,-1),-45) # green 100% middle
        Quad((1,0,0,0.3),(1,1,0),-90)  # red 30% nearest
    else:
        twDrawString(TextLeft,-0.4,0, "nearest to farthest")
        Quad((1,0,0,0.3),(1,1,0),-90)  # red 30% nearest
        Quad((0,1,0,1.0),(1,1,-1),-45) # green 100% middle
        Quad((0,0,1,0.6),(3,0,-2),0)   # blue 60% farthest
